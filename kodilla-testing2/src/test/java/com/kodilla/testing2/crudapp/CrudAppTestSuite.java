...
public class CrudAppTestSuite {
  ...
  //  }
        ...
        driver.findElements(
                ...
                .forEach(theForm -> {
                    ...
                    WebElement buttonCreateCard =
                            theForm.findElement(By.xpath(".//button[contains(@class, \"datatable__button--card-creation\")]"));
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("cehakm@gmail.com"); // [3]
        driverTrello.findElement(By.id("password")).sendKeys("ChmurkaSHTH00#"); // [4]
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit(); // [5]

        Thread.sleep(4000);

        driverTrello.findElement(By.id("password")).sendKeys("ChmurkaSHTH00#");
